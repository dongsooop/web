  ...
  return (
    <fieldset className="flex flex-col gap-4 px-4">
      ...
      <button
        type="button"
        onClick={onOpen}
        className="border-gray2 active:border-primary focus-visible:border-primary focus-visible:ring-primary/20 flex h-12 w-full cursor-pointer items-center justify-between rounded-xl border bg-white px-4 transition-all outline-none focus-visible:ring-2"
      >
