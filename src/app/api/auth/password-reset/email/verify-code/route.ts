...
import { verifyPasswordResetCodeWithSpring } from '@/features/auth/server/auth.api';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await verifyPasswordResetCodeWithSpring(payload, { appCheckToken });
