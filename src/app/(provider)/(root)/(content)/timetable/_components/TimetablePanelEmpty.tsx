...
export default function TimetablePanelEmpty() {
  return (
    <aside className="flex min-h-0 flex-col bg-white" aria-label="선택 전 강의 안내">
      <div className="flex flex-1 px-6 pt-[5.625rem] pb-6">
        <section className="bg-gray7 flex min-h-45 w-full flex-col items-center justify-center rounded-2xl px-6 text-center sm:min-h-60">
          <div className="shadow-schedule-icon flex h-14 w-14 items-center justify-center rounded-2xl bg-white sm:h-16 sm:w-16">
            <GraduationCap className="text-gray5 h-7 w-7 sm:h-8 sm:w-8" aria-hidden="true" />
          </div>
